...
public class ArraysZombieAttack1_127 {
    public static void main(String[] args) {
        ...
        do {
            ...
            for (int i = 0; i < inhabitants.length; i++) {
                inhabitants[i] /= 2;
                sumOfInhabitants += inhabitants[i];
            }
            day++;
        } while (sumOfInhabitants != 0);
        System.out.println("Day " + day + " " + Arrays.toString(inhabitants));
...
population until all cities have no humans left. Make updates to each element in
the array And print the array like below for each day:
