...
The highest and lowest scores are thrown out, and the remaining
scores are added together. The sum is then multiplied
...
Use System.out.printf("Total: %.2f",total); in order to
get rid of extra floating points.
