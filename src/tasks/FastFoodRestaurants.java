...
public class FastFoodRestaurants {
    public static void main(String[] args) {
        ...
        System.out.println("TASK 1. Find how many restaurants and print");
        ...
        System.out.println("TASK 2. Print each restaurant information in separate line starting with a number.");
        //1. 3022 5th Ave S,Fort Dodge,Jimmy Johns,50501,IA,http://www.jimmyjohns.com
        int i = 1;
        for (String eachRestaurant : restaurants) {
            System.out.println(i + ". " + eachRestaurant);
            i++;
        }

        //TASK 3. count how many "McDonald's" in array
        System.out.println("TASK 3. count how many \"McDonald's\" in array");
        int mcdonalsCount = 0;
        for (String eachRestaurant : restaurants) {
        ...
        System.out.println("TASK 4. Count number of Popeye's Chicken, Domino's Pizza, Taco Bell");
        int popeyesCount = 0;
        int dominosCount = 0;
        int tacoBellCount = 0;
        for (String eachRestaurant : restaurants) {
            if (eachRestaurant.contains("Popeye's Chicken"))
                popeyesCount++;
            else if (eachRestaurant.contains("Domino's Pizza"))
                dominosCount++;
            else if (eachRestaurant.contains("Taco Bell"))
                tacoBellCount++;
        }
        ...
        /*
        1. 4622 S Fort Hood St,Killeen,McDonald's,76542,TX,
        http://www.mcdonalds.com/?cid=RF:YXT_FM:TP::Yext:Referralhttp://mcdonalds.com
        2. 343 S Java Hood St,Killeen,McDonald's,12345,TX,
        http://www.mcdonalds.com/?cid=RF:YXT_FM:TP::Yext:Referralhttp://mcdonalds.com
         */
        System.out.println("TASK 5. Find all McDonald's in TX and print out info with number:");
        int k = 1;
        for (String eachTxRestaurant : restaurants) {
            if (eachTxRestaurant.contains("McDonald's") && eachTxRestaurant.contains(",TX")){
                System.out.println(k + ". " + eachTxRestaurant);
                k++;
            }
        }
