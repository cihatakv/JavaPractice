...
public class JobTitle {
    public static void main(String[] args) {
        ...
        System.out.println("TASK 1. Print all job titles - hint ( substring, indexOf)");
        for (String employee : employees) {
            System.out.println(employee.substring(employee.indexOf("[") + 1, employee.indexOf("]")));
        }
        System.out.println();
        System.out.println("============");
        System.out.println();
...
//        Ulrika-Goolding Nuclear Power Engineer
        System.out.println("//TASK 2: Print all FirstName-lastName jobTitle");
