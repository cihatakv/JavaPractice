...
public class ToyotaInventory {
    public static void main(String[] args) {
        ...
        //Hint : first count toyota to find out your new array
        // size then fill it up with toyota cars
        int cntToyota = 0;
        for (String eachCar : cars) {
            if (eachCar.toUpperCase().contains("TOYOTA"))
                cntToyota++;
        }

        String[] toyotaInventory = new String[cntToyota];

        int index = 0;
        for (String eachCar : cars) {
            if (eachCar.toUpperCase().contains("TOYOTA")) {
                toyotaInventory[index] = eachCar;
                index++;
                System.out.println(index + ". " + eachCar);
            }
        }
    }
}
