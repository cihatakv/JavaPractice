...
public class MovieUtility {
    ...
    public static void printMovieInformation(Movie movieObj) {
        ...
        System.out.println("The movie " + movieObj.getName() + " is "
                + movieObj.getLength() + " hour long and it's genre is " + movieObj.getType());
    ...
    public static void printShorterMovieName(Movie movieObj1, Movie movieObj2) {
        ...
        if (movieObj1.getLength() < movieObj2.getLength())
            System.out.println("printShorterMovieName = " + movieObj1.getName());
        else
            System.out.println("printShorterMovieName = " + movieObj2.getName());
    }
...
//        return false;
    ...
    public static String getCombinedMovieInfo(Movie movieObj) {
        ...
        combinedResult += movieObj.getType();
    ...
    public static List<Movie> getMyFavoriteMovies() {
        ...
        //TODO YOUR CODE HERE
        movieLst.add(new Movie("Gladiator", 2.2, "Action"));
        movieLst.add(new Movie("Lord Of The Rings", 3.5, "Drama"));
        movieLst.add(new Movie("Shawshank Redemption", 3.0, "Drama"));
